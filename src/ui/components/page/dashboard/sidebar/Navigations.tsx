...
const NavigationItem = ({
  ...
  return (
    <Link
      ...
      href={href}
      className={cn(
        `flex gap-2 items-center p-2 rounded-md transition-all duration-300 ${isActive ? "bg-primary text-primary-foreground opacity-100" : "hover:bg-secondary hover:text-secondary-foreground"} hover:scale-95 active:scale-90 opacity-90`,
      )}
    >
