...
const TaskCardContext = createContext<TaskCardContextValues | null>(null);
...
export const useTaskCardContext = () => {
  ...
  if (!ctx) {
    throw new StandardError(
      "out_of_context",
      "TaskCardContext can only be used inside its provider",
    );
  }
      ...
      <ContextMenu>
        <ContextMenuTrigger asChild>
          ...
          >
            ...
            {/* Description */}
            <p className="text-sm flex-1 opacity-70 font-light">
              No description
            </p>
