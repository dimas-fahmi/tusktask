...
import { buttonVariants } from "@/src/ui/components/shadcn/ui/button";
  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_selected: "bg-tt-quaternary !text-tt-quaternary-foreground",
        day_today: "bg-tt-secondary text-tt-secondary-foreground",
        day_outside:
